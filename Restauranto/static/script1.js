...
function applyRandomNumbers() {
    ...
    let subscribersElement = document.querySelector('.subscribers');
    let downloadsElement = document.querySelector('.downloads');
    ...
    userElement.textContent = `${userRandomNumber}K`;
    subscribersElement.textContent = `${subscribersRandomNumber}K`;
    downloadsElement.textContent = downloadsRandomNumber;
    productsElement.textContent = productsRandomNumber;
}

setInterval(applyRandomNumbers, 1000); // Adjust the interval as needed (milliseconds)
